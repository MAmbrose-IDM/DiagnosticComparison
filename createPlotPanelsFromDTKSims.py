...
# Scenarios: sampling dates and LH multipliers
...
#             verticalalignment='center', rotation=90, fontweight='bold')
#
# fig.suptitle('Probability at least one positive sample will be detected given circulation is not occurring')
#
# plt.show()
...
# same as above, but now have all P(circulation) and SS values in the same plot (different plots for different LHs
